...
| **Async Client** | [AsyncAIClient.cs](file:///C:/Users/SIK/Documents/antigravity/mysterious-carson/Source/AsyncAIClient.cs) | Coordinates non-blocking HTTP requests using Unity's `UnityWebRequest` wrapped inside coroutines. Implements interfaces for all 6 backends, handles Gemini Flash Lite prompt expansions, and requests Google Veo 3.1 Lite video generations. |
